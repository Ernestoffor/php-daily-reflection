...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Daily Reflections By Fr Steve Nwabuike</title>
    ...
    <body class="antialiased">
        <div class="relative  items-top  min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="navbar-brand justify-left" style="display:flex ; 
                position: absolute;
                left: 20px;
                width: 100px;
                height: 120px;
           ...
           <div style="padding: 10px 5px 5px 50px;">
                <h2 style=" text-align:center">This is the contact Page. Reach out for help.</h2>
                

           </div>

           <div  style="display: flex; justify-content: center;">
           <img src="/assets/church3.png" style="padding: 5px 50px 5px 50px ; height:300px; 
                    width: 500px ">
           </div>
